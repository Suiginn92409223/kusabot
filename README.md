# サーバル bot の機能 (scripts/chat.js)

- サーバル bot が参加しているチャンネルの :草-ipamj明朝: のリアクションをもらった数をカウントしてくれます。
- 「いいねいくつ？」と発言すると、自身が :草-ipamj明朝: のリアクションをもらった数を教えてくれます。
- キリのいい数 :草-ipamj明朝: のリアクションをもらうと祝ってくれます。
